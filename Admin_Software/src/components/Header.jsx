                ...
                <div className="grid grid-cols-4 gap-1.5 text-xs font-bold">
                  {['C','⌫','%','/','7','8','9','*','4','5','6','-','1','2','3','+','0','.','='].map(char => (
                    <button 
                      ...
                      className={`p-2 rounded-lg font-bold transition-all shadow-xs ${
                        char === '=' 
...
export const SubHeader = () => {
  ...
  const [company, setCompany] = useState(() => localStorage.getItem('companyName') || localStorage.getItem('erp_company') || 'ALLCORE SOLUTION PVT. LTD.');
